...
//Assignment No.3
//1.Write a program to stimulate CPU Sheduling Algorithms FCFS
//INPUT:
//package FCFS;

import java.io.*;
import java.util.Scanner;
public class spos3_FCFS
{
    public static void main(String args[])
    {
        ...
        for(i=0;i<no_p;i++)
        {
            System.out.print("\tP"+(i+1)+": "); burst_time[i]=s.nextInt();
        }
        for(i=1;i<no_p;i++)
        {
